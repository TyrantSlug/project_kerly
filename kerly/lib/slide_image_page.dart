...
class _SlideImageAddState extends State<SlideImageAdd> {
  ...
  Future<void> _urlUpload() async {
    ...
    String url = 'http://15.164.56.106:9007/file-service/urlUpload';
  ...
  Future<void> loadData() async {
    ...
    try {
      String url = 'http://15.164.56.106:9007/file-service/all';
  ...
  void urlDelete(index) async {
    ...
    String url = "http://15.164.56.106:9007/file-service/urlDelete";
