...
class _UserReplyListPageState extends State<UserReplyListPage> {
  ...
  Future<void> loadData({bool resetPage = false}) async {
    ...
    try {
      String url =
          'http://15.164.56.106:9007/reply-service/replys/bid?bid=${widget.id}&pageNum=${pageNum}';
  ...
  Future<void> replyDelete({required int id}) async {
    try {
      String url = 'http://15.164.56.106:9007/reply-service/delete';
  ...
  Future<void> _replyinsert() async {
    String url = "http://15.164.56.106:9007/reply-service/user/replys";
